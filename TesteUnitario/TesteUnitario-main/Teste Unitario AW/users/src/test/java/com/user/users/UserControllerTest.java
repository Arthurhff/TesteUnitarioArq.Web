...
public class UserControllerTest {
    ...
    void deveListarUsers() {
        List<User> mockUsers = Arrays.asList(
                new User(1L, "Stevao", "stevao@email.com"),
                new User(2L, "Joana", "joana@email.com")
        );
    ...
    @Test
    void deveSalvarUser() {
        User user = new User(null, "Jorge", "jorge@email.com");
        User savedUser = new User(1L, "Jorge", "jorge@email.com");
